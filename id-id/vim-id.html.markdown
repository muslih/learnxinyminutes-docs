...
translators:
    - ["Muslihul Aqqad", "http://github.com/muslih"]
filename: LearnVim.txt
---


[Vim](http://www.vim.org)
(Vi IMproved) adalah turunan dari salah satu editor populer di Unix yang bernama vi. Sebuah text editor yang di desain untuk kecepatan dan meningkatkan produktifitas, dan vi ini ada di kebanyakan sistem operasi berbasis unix. Vim memiliki banyak sekali tombol pintasan yang mempercepat nafigasi pada suatu poin di sebuah file, dan tentunya mempercepat dalam proses edit.

## Navigasi dasar dalam Vim
```
    vim <namafile>   # Buka <namafile> di Vim
    :help <topik>    # Buka bantuan dokumentasi <topik> bila ada
    :q               # Keluar dari Vim
    :w               # Simpan file
    :wq              # Simpan file lalu keluar dari Vim
    ZZ               # Simpan file lalu keluar dari Vim
